  ...
  const askContractToMintNft = async () => {
    try {
      ...
      if (ethereum && !!contract) {
        ...
        const asset = AssetGenerator.generate(contract);
        ...
        setError("");
        setOpenSeaLink(
          `https://testnets.opensea.io/assets/${CONTRACT_ADDRESS}/${totalMints}`
        );
      ...
      <div className="container">
        <div className="header-container">
          ...
          <p className="sub-text">
            Click "Mint NFT" to generate your own unique NFT!
          </p>
          {currentAccount !== ""
            ? renderMintUI()
